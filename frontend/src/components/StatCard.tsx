...
export default function StatCard({ title, value, icon: Icon, color, subtitle, trend, invertTrend }: Props) {
  const trendGood = trend !== undefined && (invertTrend ? trend < 0 : trend >= 0);
